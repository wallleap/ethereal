...
<p style="text-align: center;">使用 Vite 4 搭建的 Vue 2 博客，免费使用</p>

<p style="text-align: center;"><a href="#online-demo">查看预览</a> | <a href="./docs/guide.md">使用文档</a></p>
